...
async function getCoupling(heroku, app) {
    cli_ux_1.default.log('Fetching app info...');
...
async function getRelease(heroku, app, releaseId) {
    cli_ux_1.default.log('Fetching release info...');
...
async function streamReleaseCommand(heroku, targets, promotion) {
    ...
    async function streamReleaseOutput(releaseStreamUrl) {
        ...
        const fetchResponse = await node_fetch_1.default(releaseStreamUrl);
...
class Promote extends command_1.Command {
    async run() {
        ...
        cli_ux_1.default.log(`Fetching apps from ${color_1.default.pipeline(coupling.pipeline.name)}...`);
        ...
        cli_ux_1.default.log('Waiting for promotion to complete...');
